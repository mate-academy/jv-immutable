...
public final class Car {
    ...
    public Car(int year, String color, List<Wheel> wheels, Engine engine) {
        this.year = year;
        this.color = color;
        this.wheels = creatCopyWhells(wheels);
    ...
    public Car addWheel(Wheel newWheel) {
        List<Wheel> wheelList = creatCopyWhells(this.wheels);
    ...
    private List<Wheel> creatCopyWhells(List<Wheel> wheels) {
