...
public final class Car implements Cloneable {
    ...
    public List<Wheel> getWheels() {
        return createWheelsListDeepCopy(wheels);
    }
    ...
    public Car changeEngine(Engine engine) {
        return new Car(year, color, createWheelsListDeepCopy(wheels), engine);
    }

    public Car changeColor(String newColor) {
        return new Car(year, newColor, createWheelsListDeepCopy(wheels), engine.clone());
    }

    public Car addWheel(Wheel newWheel) {
        List<Wheel> newWheels = createWheelsListDeepCopy(wheels);
