...
public final class Car {
    ...
    public Car(int year, String color, List<Wheel> wheels, Engine engine) {
        ...
        this.engine = copyOfEngien(engine);
    }
    ...
    public Car addWheel(Wheel newWheel) {
        List<Wheel> wheelsList = new ArrayList<>(this.wheels);
        wheelsList.add(newWheel.clone());
    ...
    private Engine copyOfEngien(Engine engine) {
