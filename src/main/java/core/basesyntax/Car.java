...
public final class Car {
    ...
    public Car(int year, String color, List<Wheel> wheels, Engine engine) {
        ...
        this.color = color;
        if (wheels == null) {
            throw new NullPointerException("Can't create a car without wheels " + wheels);
        }
        this.wheels = new Wheel().getClone(wheels);
    ...
    public Car addWheel(Wheel newWheel) {
        Car newCar = new Car(this.year, this.color, getWheels(), getEngine());
