...
public final class Car {
    ...
    public Car changeEngine(Engine engine) {
        if (engine != null) {
            Car car = new Car(getYear(), getColor(), getWheels(), engine);
            return car;
        }
        return this;
    }
    ...
    public Car changeColor(String newColor) {
        Car car = new Car(getYear(), newColor, getWheels(), getEngine());
        return car;
    }
    ...
    public Car addWheel(Wheel newWheel) {
        ...
        Car car = new Car(getYear(), getColor(), newWheelList, getEngine());
        return car;
    }
