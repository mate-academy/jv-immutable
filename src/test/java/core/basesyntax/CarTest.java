...
public class CarTest {
    ...
    public void setRadius_isWheelsInCarChanged() {
        ...
        Assert.assertEquals("New wheel radius should be different.\n", 14, newWheel.getRadius());
    }
    ...
    public void classEngine_checkCloneIsReturnedInGetEngine() {
        ...
        Engine newEngine = new Engine(0, originalEngine.getManufacturer());
    ...
    public void classWheel_checkDeepListCloneIsReturnedInGetWheels() {
        ...
        // Створюємо об'єкт Wheel
        Wheel wheel = new Wheel(initialWheelRadius);
        Car car = new Car(1995, "Blue", List.of(wheel), testEngine);

        // Отримуємо копію колеса через метод getWheels
        List<Wheel> wheels = car.getWheels();
        // Створюємо нове колесо з новим радіусом, але без зміни оригінального
        Wheel newWheel = new Wheel(1);

        // Перевіряємо, чи не змінився оригінальний радіус колеса в машині
